...
//WiFi creds ----------------------------------------------------------------------------------
char ssid[] = "JonesWIFI"; //  your network SSID (name)
char pass[] = "livijosh2012";    // your network password (use for WPA, or use as key for WEP)
//------------------------------------------------------------------------------------------------------
...
//------------------------------------------------^^^^^^^^^^^^^^^^^^^^-----------------------
#define auth_code "ANZkWUwxrWeBiCvQhzqZ" //ex: ANQEgiAOjkQWjKvhNWIN
